...
public class SceneSwitchWindow : EditorWindow
{
    ...
    private readonly float REFRESH_OFFSET = 4f;

    [MenuItem("Window/PAPERMASK Utility/Auto Scene Switcher")]
    public static void ShowWindow()
    {
        GetWindow<SceneSwitchWindow>("Auto Scene Switcher");
    }
    ...
    private void DrawFolderTabs()
    {
        ...
        var sortedFolders = folderNames.OrderBy(f => f).ToArray();
